...
function getStatusLabel(status: string | null) {
  switch (status) {
    ...
    case "analysis_running":
      return "Analyse lÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¤uft";
    case "analysis_done":
      return "Analyse fertig";
    case "manual_review":
      return "Manuelle PrÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¼fung";
    case "offer_created":
      return "Angebot erstellt";
    case "offer_sent":
      return "Angebot gesendet";
    case "confirmed":
      return "BestÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¤tigt";
    case "cancelled":
      return "Abgebrochen";
    default:
...
function getOfferStatusLabel(status: string | null) {
  switch (status) {
    ...
    case "matching_done":
      return "ProduktvorschlÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¤ge erstellt";
    case "offer_created":
      return "Angebot erstellt";
    case "offer_sent":
      return "Angebot gesendet";
    ...
    case "confirmed":
      return "BestÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¤tigt";
    default:
      return status || "ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â";
  }
}
...
function getAiStatusLabel(status: string | null) {
  switch (status) {
    case "pending":
      return "Offen";
    case "running":
      return "LÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¤uft";
    case "done":
      return "Fertig";
    case "error":
      return "Fehler";
    ...
    case "unsupported_file_type":
      return "Dateityp nicht unterstÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¼tzt";
...
function getMatchScoreLabel(score: unknown) {
  ...
  if (value >= 55) return "MÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¶glich";
  return "PrÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¼fen";
}
...
function getOfferItemSourceLabel(source: string | null) {
  switch (source) {
    case "auto_preselected":
      return "Automatisch vorausgewÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¤hlt";
    case "auto_safe_match":
      return "Sicher automatisch ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¼bernommen";
    case "match":
      return "Aus Produktvorschlag ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¼bernommen";
    case "admin_manual":
      return "Manuell im Admin ergÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¤nzt";
    case "manual":
      return "Manuell ergÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¤nzt";
    case "customer":
    case "customer_selected":
      return "Vom Kunden gewÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¤hlt";
    default:
...
function getQuestionStatusLabel(status: string | null) {
  switch (status) {
    ...
    case "resolved":
      return "Erledigt";
    case "cancelled":
      return "ZurÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¼ckgezogen";
    default:
      return status || "Unbekannt";
  }
}
...
function getArchiveReasonLabel(reason?: string | null) {
  switch (reason) {
    case "auto_unpaid_14_days":
      return "Automatisch archiviert: lÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¤nger als 14 Tage nicht bezahlt";
    default:
...
export default async function AdminRequestDetailPage({ params }: Params) {
  ...
  if (offerItemsError) {
    throw new Error(
      `AusgewÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¤hlte Produkte konnten nicht geladen werden: ${offerItemsError.message}`
    );
  }

  if (questionsError) {
    throw new Error(
      `RÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¼ckfragen konnten nicht geladen werden: ${questionsError.message}`
    );
  }
  ...
  if (itemIds.length > 0) {
    ...
    if (matchesError) {
      throw new Error(
        `ProduktvorschlÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¤ge konnten nicht geladen werden: ${matchesError.message}`
      );
    }
  ...
  const manualReviewItems = items.filter((item) => {
    ...
    // ZÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¤hlt alle Positionen, die noch nicht im Paketwunsch liegen
      ...
      <section className="mx-auto flex w-full max-w-7xl flex-col gap-6 px-4 py-6 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
              <div>
                ...
                <p className="mt-2 max-w-3xl text-sm font-semibold leading-6 text-[#7A1D1D]">
                  ...
                  VorgangszÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¤hler mehr.
                </p>
                {request.archived_at ? (
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          ...
          >
            ...
            ZurÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¼ck zur ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Â¦ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œbersicht
          </Link>
            ...
            {customerOfferUrl ? (
              <>
                ...
                >
                  ...
                  Kundenseite ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¶ffnen
                </a>
          ...
          <div className="grid gap-6 lg:grid-cols-[1fr_360px] lg:items-start">
            <div>
              ...
              <p className="mt-3 max-w-3xl text-sm leading-6 text-[#52616F] sm:text-base">
                ...
                ProduktprÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¼fung, danach Paketwunsch-Mail, Rechnung, Zahlung und
                Abwicklung. SpÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¤tere Schritte liegen bewusst weiter unten.
              </p>
            </div>
        ...
        <section className="grid gap-4 md:grid-cols-4">
          ...
          <div className="rounded-[28px] border border-[#E8DED2] bg-white p-5 shadow-sm">
            ...
            <p className="text-xs font-black uppercase tracking-[0.16em] text-[#A75B28]">
              VorschlÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¤ge
            </p>
          ...
          <div className="rounded-[28px] border border-[#E8DED2] bg-white p-5 shadow-sm">
            ...
            <p className="text-xs font-black uppercase tracking-[0.16em] text-[#A75B28]">
              Manuell prÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¼fen
            </p>
                  ...
                  signedFiles.map((file) => (
                    ...
                    >
                      ...
                      <p className="mt-1 text-xs font-semibold text-[#52616F]">
                        {formatFileSize(file.file_size)} ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â·{" "}
                      ...
                      {file.signedUrl ? (
                        ...
                        >
                          ...
                          Datei ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¶ffnen
                        </a>
                      ) : null}
                    </div>
                  ))
                    ...
                    >
                        ...
                        return (
                          <div className="mt-3 rounded-2xl border border-[#D9E8F5] bg-white p-3 text-xs text-[#102A43]">
                            <p className="text-[11px] font-black uppercase tracking-[0.14em] text-[#12395F]">
                              Zuordnung prÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¼fen
                            </p>
                            ...
                            <div className="mt-3 rounded-xl bg-[#F7FBFF] p-3">
                              ...
                              {sourceItem ? (
                                ...
                                <p className="mt-1 font-semibold leading-5 text-[#B5282D]">
                                  Keine gelesene Listenposition verknÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¼pft. Das ist
                            ...
                            <div className="mt-2 rounded-xl bg-[#FFF8EE] p-3">
                              <p className="text-[11px] font-black uppercase tracking-[0.12em] text-[#A75B28]">
                                ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Â¦ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œbernommener Shopartikel
                              </p>
                      ...
                      {item.source === "admin_manual" ? (
                        <p className="mt-2 inline-flex rounded-full bg-white px-3 py-1 text-xs font-black text-[#A75B28]">
                          Manuell ergÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¤nzt
                        </p>
                      ) : null}
          ...
          <section className="space-y-6">
            ...
            <section className="rounded-[32px] border border-[#E8DED2] bg-white p-5 shadow-sm sm:p-6">
              <div className="mb-5 flex items-start gap-3">
                ...
                <div>
                  ...
                  <h2 className="text-xl font-black text-[#102A43]">
                    Positionen, VorschlÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¤ge und manuelle Bearbeitung
                  </h2>

                  <p className="mt-1 text-sm leading-6 text-[#52616F]">
                    Unter jeder Position findest Du dauerhaft den Bereich
                    ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã¢â‚¬Â¦Ãƒâ€šÃ‚Â¾Manuelle BearbeitungÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã¢â‚¬Â¦ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œ. Wenn keine Positionen erkannt
                    wurden, kannst Du trotzdem direkt Produkte in den
                    Paketwunsch ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¼bernehmen.
                  </p>
                </div>
              </div>
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="mt-3 inline-flex rounded-full bg-white px-3 py-1 text-xs font-black text-[#52616F]">
                          {itemIsDone ? "Details ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¶ffnen" : "Details einklappen"}
                        </div>
                        </summary>
                          ...
                          <div className="mt-4 rounded-2xl border border-[#BFE3CD] bg-[#F0FFF6] p-4">
                            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                              ...
                              <AdminResolveRequestItemButton
                                ...
                                buttonLabel="Wieder ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¶ffnen"
                        ...
                        <div className="mt-4 rounded-2xl border border-[#E8DED2] bg-white p-4">
                          <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                            <div>
                              <p className="text-xs font-black uppercase tracking-[0.16em] text-[#A75B28]">
                                RÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¼ckfragen
                              </p>
                              <p className="mt-1 text-sm font-semibold leading-6 text-[#52616F]">
                                Stelle hier eine konkrete RÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¼ckfrage zu dieser Listenposition.
                                    ...
                                    <div>
                                      <div className="mb-2 flex flex-wrap items-center gap-2">
                                        <span className="rounded-full bg-[#F0FFF6] px-3 py-1 text-xs font-black text-[#2F7D50]">
                                          {getMatchScoreLabel(match.match_score)} ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â·{" "}
                                          {toNumber(match.match_score, 0)} %
                                        </span>

                                        {isSelected ? (
                                          <span className="rounded-full bg-[#102A43] px-3 py-1 text-xs font-black text-white">
                                            AusgewÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¤hlt
                                          </span>
                                        ) : null}
                                      </div>
                          ...
                          <div className="mt-4 rounded-2xl border border-[#E16B6B] bg-[#FFF1F1] px-5 py-5 text-center">
                            <div className="flex flex-col items-center justify-center gap-2">
                              ...
                              <p className="text-[12px] font-black uppercase tracking-[0.16em] text-[#B42318]">
                                Manuelle PrÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¼fung
                              </p>
                        ...
                        <div className="mt-4 rounded-2xl border border-[#D8C8B8] bg-white p-4">
                          <div className="flex items-start gap-3">
                            ...
                            <div className="min-w-0 flex-1">
                              ...
                              <p className="mt-1 text-sm font-semibold leading-6 text-[#52616F]">
                                Hier kannst Du fÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¼r diese erkannte Position
                                jederzeit einen zusÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¤tzlichen oder ersetzenden
                                Artikel in den Paketwunsch ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¼bernehmen.
                              </p>
                              ...
                              <AdminManualOfferItemForm
                                ...
                                buttonLabel="Manuell Produkt ergÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¤nzen"
                              />
                            </div>
                          </div>
                        </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="mt-2 text-sm font-semibold leading-6 text-[#52616F]">
                        ...
                        erscheinen anschlieÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Â¦Ãƒâ€šÃ‚Â¸end auf der Kundenseite und kÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¶nnen
                      ...
                      <AdminManualOfferItemForm
                        ...
                        defaultProductName=""
                        defaultQuantity={1}
                        buttonLabel="Produkt ohne erkannte Position hinzufÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¼gen"
                      />
                    </div>
                  </div>
                </div>
            ...
            <section className="rounded-[28px] border border-[#C8D8E8] bg-[#EEF4FA] p-5 shadow-sm">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-xs font-black uppercase tracking-[0.16em] text-[#12395F]">
                    NÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¤chster Abschnitt
                  </p>
                  <h2 className="mt-1 text-xl font-black text-[#102A43]">
                    Rechnung, Zahlung und Abwicklung
                  </h2>
                  <p className="mt-2 text-sm font-semibold leading-6 text-[#52616F]">
                    Diese Schritte kommen erst nach der fachlichen ProduktprÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¼fung.
