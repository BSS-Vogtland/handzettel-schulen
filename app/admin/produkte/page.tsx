            ...
            <div>
              ...
              <div className="mt-5 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
                ...
                <Link
                  ...
                  className="inline-flex min-h-12 items-center justify-center gap-2 rounded-2xl bg-[#A75B28] px-4 py-3 text-sm font-black text-white shadow-sm transition hover:brightness-110"
                >
