          ...
          >
            ...
            <div className="mt-4 grid grid-cols-2 gap-3 sm:grid-cols-4">
              {[
                ...
                { label: "RÃƒÆ’Ã‚Â¼ckfragen", value: group.questionCount },
              ].map((metric) => (
                <div
                  key={metric.label}
              ...
              <div className="mt-4 rounded-2xl border border-[#E8DED2] bg-[#FBF7F0] p-3">
                ...
                <ul className="mt-2 grid gap-1 text-sm font-semibold leading-6 text-[#102A43]">
                  {group.previewOfferItems.map((name, index) => (
                    <li key={index}>ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ {name}</li>
                  ))}
                </ul>
...
function getK4e2OfferSourceLabel(item: OfferItem) {
  ...
  switch (source) {
    ...
    case "admin_manual":
    case "admin_existing_product":
      return "Vom Team ergÃƒÆ’Ã‚Â¤nzt";
    default:
            ...
            <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
              <div>
                ...
                <p className="mt-3 max-w-3xl text-sm font-semibold leading-6 text-[#52616F]">
                  Erkannte Artikel liegen bereits im Paket. FÃƒÆ’Ã‚Â¼r offene Positionen entscheidest Du zuerst:
                  selbst auswÃƒÆ’Ã‚Â¤hlen oder von Handzettel-Schulen.de ÃƒÆ’Ã‚Â¼bernehmen lassen.
                </p>
              </div>
