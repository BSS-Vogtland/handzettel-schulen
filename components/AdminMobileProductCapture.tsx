...
export default function AdminMobileProductCapture() {
  ...
  function quickSetProductType(type: string) {
    setProductType(type);
  ...
  return (
    ...
    >
      ...
      <div className="grid gap-4">
        <section className="rounded-[28px] border border-[#E8DED2] bg-[#FBF7F0] p-3">
          <div className="mb-3 flex items-center justify-between gap-3">
            <div>
              ...
              <p className="mt-1 text-xs font-semibold text-[#52616F]">
                Direkt mit der Handykamera aufnehmen.
              </p>
            </div>
            ...
            {productImage ? (
              <button
                ...
                className="flex h-9 w-9 items-center justify-center rounded-full bg-white text-[#B5282D] shadow-sm"
          ...
          {previewUrl ? (
            <div className="overflow-hidden rounded-[24px] border border-[#E8DED2] bg-white">
              <img
                src={previewUrl}
                alt="Produktfoto"
            ...
            <label className="flex min-h-64 cursor-pointer flex-col items-center justify-center rounded-[24px] border-2 border-dashed border-[#D8C8B8] bg-white px-4 py-8 text-center transition hover:border-[#12395F]">
              <Camera className="mb-3 h-10 w-10 text-[#A75B28]" />
          ...
          {previewUrl ? (
            <label className="mt-3 inline-flex min-h-11 w-full cursor-pointer items-center justify-center gap-2 rounded-2xl bg-[#12395F] px-4 py-3 text-sm font-black text-white transition hover:brightness-110">
        ...
        <section className="rounded-[28px] border border-[#E8DED2] bg-[#FBF7F0] p-4">
          ...
          <div className="mt-3 grid grid-cols-2 gap-2 sm:grid-cols-4">
            {[
              ...
              { label: "Mappe", value: "mappe" },
              { label: "Stift", value: "stift" },
            ].map((item) => (
              <button
                key={item.value}
                type="button"
                onClick={() => quickSetProductType(item.value)}
                className={`min-h-11 rounded-2xl border px-3 py-2 text-sm font-black transition ${
                  productType === item.value
                    ...
                    : "border-[#E8DED2] bg-white text-[#102A43] hover:border-[#12395F]"
                }`}
              >
                {item.label}
              </button>
        ...
        <section className="rounded-[28px] border border-[#E8DED2] bg-[#FBF7F0] p-4">
          ...
          <textarea
            ...
            rows={6}
            placeholder="Suchbegriffe werden automatisch erzeugt."
            className="w-full rounded-2xl border border-[#D8C8B8] bg-white px-4 py-3 text-sm font-bold text-[#102A43] outline-none transition placeholder:text-[#9AA7B2] focus:border-[#B5282D] focus:ring-4 focus:ring-[#B5282D]/10"
          />
        ...
        <div className="sticky bottom-3 z-10 grid gap-2 rounded-[28px] border border-[#E8DED2] bg-white/95 p-3 shadow-[0_18px_45px_rgba(16,42,67,0.16)] backdrop-blur sm:grid-cols-[1fr_auto]">
          <button
            type="submit"
            disabled={isSaving}
            className="inline-flex min-h-14 items-center justify-center gap-2 rounded-2xl bg-[#B5282D] px-5 py-4 text-base font-black text-white shadow-sm transition hover:brightness-110 disabled:cursor-not-allowed disabled:opacity-70"
          >
            {isSaving ? (
              <>
          ...
          <button
            ...
            className="inline-flex min-h-14 items-center justify-center gap-2 rounded-2xl border border-[#E8DED2] bg-[#FBF7F0] px-5 py-4 text-sm font-black text-[#12395F]"
          >
